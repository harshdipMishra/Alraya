                ...
                <ScrollView style={{ flex: 1 }}>
                    <View style={{ backgroundColor: '#fff', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 10 }}>
                        ...
                        <View style={{ flex: 5, alignItems: 'flex-start', padding: 10, }}>
                            <Text style={{ fontSize: 18, fontWeight: "bold", fontFamily: 'AvenirNextLTPro-Bold', color: "green" }}>Change Password</Text>
                        </View>
                ...
                <Footer>
                        <FooterTab success style={{ backgroundColor: '#8bc34a' }}>
                            ...
                            <Button style={{ backgroundColor: 'green' }}>
                                <Text style={{ color: "#fff", fontWeight: '700', fontSize: 14,alignSelf:'stretch',textAlign:'center' }}>Change Password</Text>
                            </Button>
                        </FooterTab>
                    </Footer>
            </>
