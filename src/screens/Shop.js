            ...
            <View style={{padding:5,margin:0}}>
               ...
               <View style={{borderColor:'#dfdfdf',borderWidth:1,marginBottom:8}}>
                 ...
                 <View style={{borderColor:'#dfdfdf',borderWidth:1,marginBottom:8}}>
                    ...
                    style={{ height:width/2.3,width:width/2.1, borderRadius:0,}}
                    />
                    <View style={{alignItems:'center',width:width/2.1,flexWrap:'nowrap',padding:10,backgroundColor:'white',}}>
                      <Text style={{fontSize:15,fontFamily:'AvenirNextLTPro-Bold',color:'#666',fontWeight:'700'}}>Perishable</Text>
                  ...
                  {/* <View style={{borderColor:'#dfdfdf',borderWidth:1,marginBottom:8}}>
                    ...
                    />
                    <View style={{alignItems:'center',width:width/2.1,flexWrap:'nowrap',padding:10,backgroundColor:'white',}}>
                      <Text style={{fontSize:15,fontFamily:'AvenirNextLTPro-Bold',color:'#666',fontWeight:'700'}}>Household Items </Text>
