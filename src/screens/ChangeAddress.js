...
import { Container, Header, Title, Content, Footer,ListItem,Radio, FooterTab, Button, Left, Right, Body, Icon, Text, Card, CardItem } from 'native-base';
                        ...
                        <Content>
                            <View style={{ backgroundColor: '#f3f6f9', padding: 15, }}>
                                <View style={{ flexDirectiom: 'row', paddingVertical: 5, marginBottom: 0, justifyContent: 'center' }}>
                                    <View style={{ flex: 3 }}>
                                        <Text style={{ fontSize: 14, fontWeight: '700' }}>Saved Address </Text>
                                    </View>
                                    <View style={{ flex: 1, position: 'absolute', right: 0 }}>
                                        <Button transparent small onPress={() => this.props.navigation.navigate('AddNewAddress')}>
                            ...
                            <Content>
                                <ListItem selected={false} >
                                    ...
                                    <View style={{justifyContent:'flex-start',alignItems:'flex-start',textAlign:'left'}}>
                                      
                                        <Text style={{color:'#000',alignSelf:'flex-start',fontSize:16,fontWeight:'700'}}>
                                          Shubhang Verma
                                        </Text>
